...
const specializationCardData = {
  ...
  headerIcon: " ",
  title: "Economics",
  subtitle: "Анализ и управление экономическими процессами.",
  actions1: [
    "Финансовый анализ",
    "Бюджетирование",
    "Анализ рынка",
  ...
  actions2: ["математика", "или", "статистика"],
};

const specializationCardMiniData = {
  icon: "icons/Calculator.svg",
  title: "Financial Analyst",
  actions: ["Финансы", "Рынки", "Прогнозирование", "Excel"],
};

const specializationCardData2 = {
  icon: "icons/ProjectorScreenChart.svg",
  title: "Market Analyst",
  actions: ["Анализ данных", "Ценообразование", "Рынки", "CRM"],
};

const specializationCardQAData = {
  icon: "icons/Scales.svg",
  title: "Economist-Statistician",
  actions1: ["Статистика", "Модели", "Экономические прогнозы"],
  actions2: ["анализ", "или", "данные"],
};

const specializationCardCEOData = {
  icon: "icons/OfficeChair.svg",
  title: "Investment Manager",
  actions: ["Инвестиции", "Финансовое планирование", "Риски", "Доходность"],
};

const specializationCardProductDesignData = {
  icon: "icons/Graph.svg",
  title: "Business Development Analyst",
  actions: ["Стратегия", "Развитие", "Координация", "Рынки"],
};
...
const specializationCardSoftwareDevData = {
  ...
  iconHeader: " ",
  title: "Data Analyst",
  subtitle: "Анализ экономических данных для принятия решений.",
  actions: ["SQL", "Power BI", "Big Data", "Python"],
};
