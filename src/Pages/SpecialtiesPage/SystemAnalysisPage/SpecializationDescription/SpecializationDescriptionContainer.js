...
const specializationDescriptionData = {
    description: [
      "Системный анализ и управление — междисциплинарная область, объединяющая математическое моделирование, анализ данных и теорию управления для оптимизации процессов. Выпускники работают в промышленности, здравоохранении, финансах и других сферах, занимаясь анализом данных, разработкой систем управления и оптимизацией процессов. Преимущества включают высокий спрос, карьерный рост и возможность создания собственных компаний. Примеры должностей: системный аналитик, специалист по управлению данными, разработчик систем управления и консультант по оптимизации процессов.",
    ],
    formats: "Очно",
    duration: "4 года",
